...
int main(void) {
    ...
    while (1) {
        ...
        if (z == 0) {
            IntegrateClosedLoop(InitDCM, Bminus, gyroInput, newmag, correctaccels, mInertial, accInertial, Rplus, Bplus);
            getEulerAngle(Rplus);
            z++;
        } else {
            IntegrateClosedLoop(Rplus, Bplus, gyroInput, newmag, correctaccels, mInertial, accInertial, Rplus, Bplus);
            getEulerAngle(Rplus);
        }
    }
}
